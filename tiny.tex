...
\begin{proof}
  ...
  \begin{align*}
    ...
    &\defeq \left( (g\stubra{\subkeyo{k}{K},\subkeyo{i}{L}})(\rbind{i}, \lambda j. a \substuck{j}{L}) \right)[h(k)/a]\sublock{L}{k}
    && \text{(Definition of $\Phi$)} \\
    &\defeq \left( (g\stubra{\subkeyo{k}{K},\subkeyo{i}{L}})(\rbind{i}, \lambda j. (h(k)) \substuck{j}{L}) \right)\sublock{L}{k}
    && \text{(Computing $[h(k)/a]$)} \\
    &\defeq (g\stubra{\subkeyo{k}{K},\subkeyo{i}{L}}\sublock{L}{k})(\rbind{i}, \lambda j. (h(k)) \substuck{j}{L}\sublock{L}{k})
...
\begin{align*}
  ...
  &\defeq \rform{L}{\left( (\prd{s : \Tiny} t\stubra{\subkeyo{l\substuck{s}{K}}{L}, \subkeyo{s}{K}} = s)\sublock{K}{l} \to \rget{B} \right)} \\
  &\defeq \rform{L}{\left( (\prd{s : \Tiny} t\stubra{\subkeyo{l\substuck{s}{K}}{L}, \subkeyo{s}{K}}\sublock{K}{l} = s) \to \rget{B} \right)} \\
